...
var marketingUserNewSchema = new Schema({
...
marketingUserNewSchema.pre('save', function(next) {
...
marketingUserNewSchema.pre('update', function(next) {
  this.update({},{ $set: { updatedAt: new Date() } });
  next();
});

var MarketingUserNew = mongoose.model('marketingusersnew', marketingUserNewSchema);
module.exports = MarketingUserNew;
