...
nv.models.multiBarChart = function() {
    ...
    chart._options = Object.create({}, {
        ...
        barColor:  {get: function(){return multibar.barColor;}, set: function(_){
            multibar.barColor(_);
            legend.color(function(d,i) {return d3.rgb('#ccc').darker(i * 2.5).toString();})
        }}
    });
...
nv.models.multiBarHorizontal = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            var wrapEnter = wrap.enter().append('g').attr('class', 'nvd3 nv-wrap horizontal nv-multibarHorizontal');
            var defsEnter = wrapEnter.append('defs');
            var gEnter = wrapEnter.append('g');
            var g = wrap.select('g');
...
nv.models.multiBarHorizontalChart = function() {
    ...
    var margin = {top: 30, right: 20, bottom: 50, left: 135}
        , width = null
        , height = null
        , color = nv.utils.defaultColor()
        , showControls = true
