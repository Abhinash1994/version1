angular.module('sbAdminApp', ['ui.calendar', 'ui.bootstrap','isteven-multi-select','daterangepicker','ngSanitize', 'ngCsv'])
    ...
    .controller('dealtestJpegCtrl', function (dealMenuContent,$scope, $compile, $http, $timeout, $window, $log,NgTableParams,Excel,$parse, $timeout,$q) {

        /*alert(parlorType);*/

    if(parlorType==0){
        $scope.backGroundImage='redMenuBackground';
        ...
        $scope.backGroundImage='blueMenuBackground';
        ...
        $scope.backGroundImage='greenMenuBackground';
  ...
  $scope.calculatePxMenuPrice=function(x){
    ...
    function printDiv() {
       var divToPrint = document.getElementById('printArea');
        ...
        myWindow.document.write("<html><head><link rel='stylesheet'  href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css'><style type='text/css' media='all' >.row{ }.para{color:"+ $scope.departmentHeadingsColor+"!important;} .image{height:1800px;} b{ line-height: 30px; }  span b{font-size:24px; } td b{font-size:22px; font-weight:200;}  .abc{margin-top:2%;margin-right:1%;margin-left:1%;} .cv{font-size:20px; font-weight:200;} @page {size:  auto;margin-top: 5cm;  margin: 0mm;scale:59;}</style>" + "</head><body>"+b+"</body></html>");
