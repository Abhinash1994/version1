...
.controller('newGurgaonCustomerReport', function($scope,$http,$timeout,$state){
...
$scope.popup1 = {
       ...
       $http.post("/role1/newClientReportOfGurgaonSalons", reqObj).success(function(response, status){
